...
- (IBAction)moveObject:(UIPanGestureRecognizer *)sender {
    if (sender.state == UIGestureRecognizerStateChanged) {
        if (switchObject) {
            ...
            flashPos.x += x.x/1000;
            flashPos.y += x.y/1000;
            flashlightPosition.x = flashPos.x;
            flashlightPosition.y = -flashPos.y;
        }
    }
}
...
//    baseModelViewMatrix = GLKMatrix4Rotate(baseModelViewMatrix, _rotation, 0.0f, 1.0f, 0.0f);
    ...
    _modelViewMatrix = GLKMatrix4Scale(_modelViewMatrix, objScale, objScale, objScale);
    ...
    _modelViewMatrix = GLKMatrix4Translate(_modelViewMatrix, cubePos.x, 0, 0);
